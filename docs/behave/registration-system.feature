Feature: Проверка регистрации через сайт и Telegram
  ...
  Scenario: Суперадмин открывает и закрывает регистрацию через Telegram
    ...
    And суперадмин подключён к боту
    When суперадмин отправляет команду открытия регистрации для "Тест ИЦАЭ — открытие и закрытие"
    ...
    When суперадмин отправляет команду закрытия регистрации для "Тест ИЦАЭ — открытие и закрытие"
